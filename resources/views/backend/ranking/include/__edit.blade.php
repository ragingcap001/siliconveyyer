                        ...
                        <div class="site-input-groups row mb-0">
                            ...
                            <div class="col-xl-4">
                                <div class="site-input-groups">
                                    ...
                                    <input type="number" name="level" class="box-input mb-0 level" min="1"
                                           required=""/>
                        ...
                        <div class="site-input-groups row mb-0">
                            ...
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    ...
                                    <div class="input-group joint-input">
                                        <input type="number" class="form-control minimum-tasks" name="minimum_tasks"
                                               min="0">
                        ...
                        <div class="site-input-groups row mb-0">
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    ...
                                    <input type="text" name="minimum_referral" value="{{ old('minimum_referral') }}"
                                           oninput="this.value = validateDouble(this.value)"
                                           class="box-input minimum-referral mb-0 " placeholder="Minimum Referral"
                                           required=""/>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    ...
                                    <div class="input-group joint-input">
                                        <input type="text" class="form-control minimum-referral-deposit"
                                               name="minimum_referral_deposit"
                                               oninput="this.value = validateDouble(this.value)">
                                        <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="site-input-groups row mb-0">
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    ...
                                    <div class="input-group joint-input">
                                        <input type="text" class="form-control minimum-task-earning"
                                               name="minimum_task_earning"
                                               oninput="this.value = validateDouble(this.value)">
                                        <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                    </div>
                                </div>
