                    ...
                    <ul>
                        ...
                        <li class="{{ isActive('user.wallet-exchange') }}">
                            <a href="{{ route('user.wallet-exchange') }}">
                                ...
                                <span>{{ __('Wallet Exchange') }}</span>
                            </a>
                        </li>
                        <li class="@if( Route::currentRouteName() != 'user.send-money.log') {{ isActive('user.send-money*') }} @endif">
                        ...
                        <li class="{{ isActive('user.send-money.log') }}">
